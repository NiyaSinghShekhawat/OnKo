import { DoctorUpdateCard } from "@/patient-dashboard/components/DoctorUpdateCard";
...
export default function PatientPage(){return <PatientShell><main className="onko-page"><WelcomeCard/><DoctorUpdateCard/><TodayCare/><SafetyAlert/><QuickNavigation/></main></PatientShell>;}
